...
Usage:
    python -m src.capabilities render <agent_name>     — render system prompt summary
    python -m src.capabilities mcp_config <agent_name> — output .mcp.json for agent
"""
...
from src.capabilities.loader import ConfigError
...
def main() -> None:
    if len(sys.argv) < 3:
        print("Usage: python -m src.capabilities <command> <agent_name>", file=sys.stderr)
