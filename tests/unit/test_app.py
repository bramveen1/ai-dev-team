...
# ── check_token_configured: fail-fast on missing ROUTER_INTERNAL_TOKEN ───────


class TestCheckTokenConfigured:
    """Router must exit at startup when ROUTER_INTERNAL_TOKEN is missing."""
    ...
    def test_no_error_when_token_present(self, monkeypatch):
        ...
        monkeypatch.setenv("ROUTER_INTERNAL_TOKEN", "tok-abc")
        internal_api.check_token_configured()
